...
;              
CREATE USER IF NOT EXISTS "SA" SALT '976d7fd391b328a4' HASH '1091dc6afbeb5b8486021bfc6d06f77a9059ded2f4eece8247ee264b5d720066' ADMIN;          
...
INSERT INTO "PUBLIC"."USER_LICENSE_SETTINGS"("ID", "GRANDFATHERED_USER_COUNT", "GRANDFATHERED_USER_SIGNATURE", "GRANDFATHERING_LOCKED", "INTEGRITY_SALT", "LICENSE_MAX_USERS") VALUES(1, 5, '5:MCWeO7YKsHOzAHmzGE6E9oD65VQmwg3oaiJtdrFCBOY', TRUE, '9fa1a67c-c3f5-442d-bac0-36116d241672', 0); 
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2025-12-04 10:47:46.268303', TRUE, FALSE, FALSE, FALSE, '$2a$10$WmLIROPXjvxAykImzV1KMej0J9LggBaQJ5CREnl0BDPhaJ/upeVWS', NULL, NULL, NULL, TIMESTAMP '2025-12-04 12:55:14.487553', 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, '0588f8a2-5327-4cf6-9fcc-958d3af3078d', 'web', TIMESTAMP '2025-12-04 10:47:46.646643', TRUE, FALSE, FALSE, FALSE, '$2a$10$bCrvoRkBHe0cg3bA4xhAjOtU75/WnPcromkz1XozenoUwZBwJgdnW', NULL, NULL, NULL, TIMESTAMP '2025-12-04 10:47:46.762343', 'STIRLING-PDF-BACKEND-API-USER', 2);          
